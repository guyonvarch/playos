...
readonly SCALING_PREF=$(cat /var/lib/gui-localization/screen-scaling 2>/dev/null || echo "default")
echo "Using scaling preference '$SCALING_PREF'"

readonly CONNECTED_OUTPUTS=$(xrandr | grep ' connected' | awk '{ print $1 }')
